...
module bus_slave_sram_ab #(
    ...
    input  logic [DW-1:0]      chip_chab_wdata_a,
    input  logic [DW-1:0]      chip_chab_wdata_b,
    ...
    // --- Scan-chain / test override for A-matrix SRAM ---
    input  logic               sc_a_mem_ctrl,
    input  logic               sc_a_cen,
    input  logic               sc_a_wen,
    input  logic [AW-1:0]      sc_a_addr,
    input  logic [63:0]        sc_a_din,
    output logic [63:0]        sc_a_mem_dout,

    // --- Scan-chain / test override for B-matrix SRAM ---
    input  logic               sc_b_mem_ctrl,
    input  logic               sc_b_cen,
    input  logic               sc_b_wen,
    input  logic [AW-1:0]      sc_b_addr,
    input  logic [63:0]        sc_b_din,
    output logic [63:0]        sc_b_mem_dout
);
    ...
    bus_slave_ab u_slave_ab (
        ...
        .chab_wdata_a (chip_chab_wdata_a),
        .chab_wdata_b (chip_chab_wdata_b),
    ...
    sram_wrapper_ab u_sram_a (
        ...
        .sc_mem_ctrl  (sc_a_mem_ctrl),
        .sc_cen       (sc_a_cen),
        .sc_wen       (sc_a_wen),
        .sc_addr      (sc_a_addr),
        .sc_din       (sc_a_din),
        .sc_mem_dout  (sc_a_mem_dout)
    );
    ...
    sram_wrapper_ab u_sram_b (
        ...
        .sc_mem_ctrl  (sc_b_mem_ctrl),
        .sc_cen       (sc_b_cen),
        .sc_wen       (sc_b_wen),
        .sc_addr      (sc_b_addr),
        .sc_din       (sc_b_din),
        .sc_mem_dout  (sc_b_mem_dout)
    );
