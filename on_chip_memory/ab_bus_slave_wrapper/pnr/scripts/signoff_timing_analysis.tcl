...
proc signoff_qrc {prefix} {
    ...
    time_design    \
        ...
        # set combined $iv::reportDir/${prefix}_combined.summary.rpt
        # exec sh -c "echo '=== SETUP ===' > $combined"
        # exec sh -c "zcat $iv::reportDir/${prefix}.summary.gz >> $combined"
        # exec sh -c "echo '=== HOLD ===' >> $combined"
        # exec sh -c "zcat $iv::reportDir/${prefix}_hold.summary.gz >> $combined"
}
