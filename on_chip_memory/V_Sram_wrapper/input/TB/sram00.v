...
//      Test Muxes                  Off
//
//      Creation Date:  Wed Feb 25 11:09:35 2026
//      Version: 	r0p0-00eac0
//
...
`celldefine
`ifdef POWER_PINS
module sram00 (Q, CLK, CEN, WEN, A, D, EMA, RETN, VSS, VDD);
`else
module sram00 (Q, CLK, CEN, WEN, A, D, EMA, RETN);
`endif
...
`endif
  ...
  reg NOT_D62, NOT_D63, NOT_D7, NOT_D8, NOT_D9, NOT_EMA0, NOT_EMA1, NOT_EMA2, NOT_RETN;
  reg NOT_WEN;
  reg clk0_int;
  reg CREN_legal;
  initial CREN_legal = 1'b1;
 ...
 wire  CLK_;
  ...
  buf B138(D_[62], D[62]);
  buf B139(D_[63], D[63]);
  buf B140(EMA_[0], EMA[0]);
  buf B141(EMA_[1], EMA[1]);
  buf B142(EMA_[2], EMA[2]);
  buf B143(RETN_, RETN);
