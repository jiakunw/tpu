...
set TOPCELL	  sram_wrapper
set vars(std_height)      1.8
# List of HDL files
set gn::VERILOG_LIST	[list "sram_wrapper.sv"]	
...
set vars(stripe,setdist)	60 ;#fix distance across design
...
###############################################################################
# HARD MACRO: SRAM
# Actual dimensions R0: W=312.26um, H=128.765um
# R0 placement: X=312.26um, Y=128.765um
###############################################################################
