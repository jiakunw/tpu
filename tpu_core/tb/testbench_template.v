...
module testbench;
    ...
    wire [IDX_WIDTH-1-3:0] c_col_idx;
    ...
    // ----- other ----- //
    wire [IDX_WIDTH-1:0] c_col_idx_ext = {c_col_idx, 3'b0};
    ...
    tpu_core DUT (
        ...
        .TEST_outcome_full_TEST  (outcome),
        .TEST_c_row_idx_TEST       (c_row_idx),
        .TEST_c_col_idx_TEST       (c_col_idx),
        .TEST_c_sram_w_en_TEST     (c_sram_w_en_TEST)
    );
    ...
    input_sram INPUT_SRAM (
        .clk     (clk),
        .wr_en_a (a_wr_en),
        .rd_en_a (a_b_sram_rd_en),
        .waddr_a (a_waddr),
        .raddr_a (a_raddr),
        .wdata_a (a_wdata),
        .rdata_a (sram_rdata_a),
        .wr_en_b (b_wr_en),
        .rd_en_b (a_b_sram_rd_en),
        .waddr_b (b_waddr),
        .raddr_b (b_raddr),
        .wdata_b (b_wdata),
    ...
    always @(posedge clk) begin
        ...
        else if(c_sram_w_en_TEST) begin
            OUT_SRAM[c_row_idx][c_col_idx_ext  ] <= outcome[(8*33)-1 -: 33];
            OUT_SRAM[c_row_idx][c_col_idx_ext+1] <= outcome[(7*33)-1 -: 33];
            OUT_SRAM[c_row_idx][c_col_idx_ext+2] <= outcome[(6*33)-1 -: 33];
            OUT_SRAM[c_row_idx][c_col_idx_ext+3] <= outcome[(5*33)-1 -: 33];
            OUT_SRAM[c_row_idx][c_col_idx_ext+4] <= outcome[(4*33)-1 -: 33];
            OUT_SRAM[c_row_idx][c_col_idx_ext+5] <= outcome[(3*33)-1 -: 33];
            OUT_SRAM[c_row_idx][c_col_idx_ext+6] <= outcome[(2*33)-1 -: 33];
            OUT_SRAM[c_row_idx][c_col_idx_ext+7] <= outcome[(1*33)-1 -: 33];
        end
    end
