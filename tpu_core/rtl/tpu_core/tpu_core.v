module tpu_core#(
    ...
    output signed   [ARRAY_SIZE*OUTCOME_WIDTH-1:0] TEST_outcome_full_TEST, // TEST
    output          [IDX_WIDTH-1:0] TEST_c_row_idx_TEST, // TEST
    output          [IDX_WIDTH-1-3:0] TEST_c_col_idx_TEST, // TEST 
    ...
    wire bias_adder_bias_sram_rd_en;
    wire [SRAM_ADDR_WIDTH-1:0] bias_adder_bias_sram_rd_addr;
    ...
    assign bias_adder_data_in = $signed(systolic_array_wrapper_sram_wdata_c);
    assign bias_adder_bias = $signed(bias);
    ...
    bias_adder bias_adder_inst (
        ...
        .bias_sram_rd_en (bias_adder_bias_sram_rd_en),
        .bias_sram_rd_addr (bias_adder_bias_sram_rd_addr),
    ...
    assign bias_sram_rd_en = bias_adder_bias_sram_rd_en;
    assign bias_addr = bias_adder_bias_sram_rd_addr;
    // ----- end ----- //
    ...
    assign scale_multiplier_data_in = $signed(bias_adder_data_out);
    ...
    assign TEST_c_col_idx_TEST = scale_multiplier_c_col_idx_out[IDX_WIDTH-1:3]; // TEST
    // ----- end ----- //
