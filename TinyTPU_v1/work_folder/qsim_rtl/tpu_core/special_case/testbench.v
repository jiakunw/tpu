...
`define HW_RESULT_TXT   "./8_1024_8_1/HW.txt"
`define HW_CLAMPED_TXT   "./8_1024_8_1/HW_clamped.txt"
`define A_TXT           "./8_1024_8_1/A.txt"
`define B_TXT           "./8_1024_8_1/B.txt"
`define C_TXT           "./8_1024_8_1/C.txt"
`define C_clamped_TXT           "./8_1024_8_1/C_clamped.txt"
`define Bias_TXT        "./8_1024_8_1/bias.txt"
`define OUT_Bias_TXT    "./8_1024_8_1/out_bias.txt"
`define OUT_SCALE_TXT       "./8_1024_8_1/out_scale.txt"
       ...
       // ----------------- Initialize SRAMs ----------------
        ...
        for(i=0; i<m*8; i=i+1) begin
            for(j=0; j<k*8; j=j+1) begin
                ...
                $fwrite(hw_result_file, "%b", OUT_SRAM[i][j]);
                $fwrite(hw_clamped_file, "%h", OUT_CLAMPED_SRAM[i][j]);
                ...
                if(temp_c !== OUT_SRAM[i][j]) begin
                    $fwrite(hw_result_file, "mismatch");
                    error_count = error_count + 1;
                end

                if(temp_clamped_c !== OUT_CLAMPED_SRAM[i][j]) begin
