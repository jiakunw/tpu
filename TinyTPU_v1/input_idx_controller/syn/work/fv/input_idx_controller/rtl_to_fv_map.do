...
# Generated on: Sun Mar 22 13:04:16 EDT 2026 (Sun Mar 22 17:04:16 UTC 2026)
...
set logfile fv/input_idx_controller/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/input_idx_controller -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../../input/RTL/in_ac_mode_controller.v ../../input/RTL/input_idx_controller.v
elaborate_design -golden -root {input_idx_controller} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/input_idx_controller/fv_map.v.gz
elaborate_design -revised -root {input_idx_controller}
...
#add_name_alias fv/input_idx_controller/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.input_idx_controller.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.input_idx_controller.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.input_idx_controller.rtl.fv_map.rpt
