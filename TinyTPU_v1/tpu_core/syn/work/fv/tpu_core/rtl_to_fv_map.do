...
# Generated on: Sun Mar 22 17:07:20 EDT 2026 (Sun Mar 22 21:07:20 UTC 2026)
...
set logfile fv/tpu_core/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/tpu_core -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/tools/cadence/GENUS/21.16/tools.lnx86"
set CDN_SYNTH_ROOT      "/tools/cadence/GENUS/21.16/tools.lnx86"
set env(CW_DIR) "/tools/cadence/GENUS/21.16/tools.lnx86/lib/chipware"
set CW_DIR      "/tools/cadence/GENUS/21.16/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /tools/cadence/GENUS/21.16/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/tools/cadence/GENUS/21.16/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/tools/cadence/GENUS/21.16/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/tools/cadence/GENUS/21.16/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/tools/cadence/GENUS/21.16/tools.lnx86/lib/chipware/sim"
}
...
add_search_path /courses/ee6350/pdk2023/T-N65-CM-SP-018-K3_MOM/Base_PDK/PDK_CRN65GP_v1.0c_official_IC61_20101010 -library -both
read_library -liberty -both \
    /courses/ee6350/pdk2023/T-N65-CM-SP-018-K3_MOM/digital/Front_End/timing_power_noise/NLDM/tcbn65gplus_200a/tcbn65gpluswc.lib
...
add_search_path ../../input/RTL/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../../input/RTL/ReLU_clamp.v ../../input/RTL/addr_converter.v ../../input/RTL/bias_adder.v ../../input/RTL/input_buffer.v ../../input/RTL/in_ac_mode_controller.v ../../input/RTL/input_idx_controller.v ../../input/RTL/input_offset_substract.v ../../input/RTL/output_buffer.v ../../input/RTL/out_ac_mode_controller.v ../../input/RTL/output_idx_controller.v ../../input/RTL/output_offset_adder.v ../../input/RTL/scale_multiplier_32x16.v ../../input/RTL/scale_multiplier.v ../../input/RTL/systolic_array_8x8.v ../../input/RTL/systolic_array_wrapper.v ../../input/RTL/tpu_core.v
elaborate_design -golden -root {tpu_core} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/tpu_core/fv_map.v.gz
elaborate_design -revised -root {tpu_core}
...
#add_name_alias fv/tpu_core/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.tpu_core.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.tpu_core.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.tpu_core.rtl.fv_map.rpt
