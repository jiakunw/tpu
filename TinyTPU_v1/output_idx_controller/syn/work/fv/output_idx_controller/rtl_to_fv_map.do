...
# Generated on: Sun Mar 22 14:07:17 EDT 2026 (Sun Mar 22 18:07:17 UTC 2026)
...
set logfile fv/output_idx_controller/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/output_idx_controller -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../../input/RTL/out_ac_mode_controller.v ../../input/RTL/output_idx_controller.v
elaborate_design -golden -root {output_idx_controller} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/output_idx_controller/fv_map.v.gz
elaborate_design -revised -root {output_idx_controller}
...
#add_name_alias fv/output_idx_controller/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.output_idx_controller.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.output_idx_controller.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.output_idx_controller.rtl.fv_map.rpt
