...
# Generated on: Sun Mar 22 09:07:23 EDT 2026 (Sun Mar 22 13:07:23 UTC 2026)
...
set logfile fv/systolic_array_wrapper/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/systolic_array_wrapper -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../../input/RTL/input_buffer.v ../../input/RTL/input_offset_substract.v ../../input/RTL/output_buffer.v ../../input/RTL/systolic_array_8x8.v ../../input/RTL/systolic_array_wrapper.v
elaborate_design -golden -root {systolic_array_wrapper} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/systolic_array_wrapper/fv_map.v.gz
elaborate_design -revised -root {systolic_array_wrapper}
...
#add_name_alias fv/systolic_array_wrapper/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.systolic_array_wrapper.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.systolic_array_wrapper.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.systolic_array_wrapper.rtl.fv_map.rpt
