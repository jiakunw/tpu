...
#  Created on Sun Mar 22 10:42:43 2026                
#                                                     
#######################################################
...
set TOPCELL	  systolic_array_wrapper	
...
set vars(fp,width)         500
set vars(fp,height)         500
...
set vars(stripe,setdist)	[expr { (($vars(fp,width))-$vars(stripe,width)-0.5*$vars(stripe,space)-0.5*$vars(fp,io_core_space))/4 }]
